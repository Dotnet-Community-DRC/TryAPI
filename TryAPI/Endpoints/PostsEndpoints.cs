...
using TryAPI.Data;
using TryAPI.Data.Models;

namespace TryAPI.Endpoints
{
    public static class PostsEndpoints
    {
        ...
        public static void MapPostsEndpoints(this WebApplication app)
        {
            ...
            app.MapPost("/posts", async (PostDTO postToCreateDTO, AppDbContext dbContext) =>
            {
            ...
            app.MapPut("/posts/{Id}", async (int Id, PostDTO updatedPostDTO, AppDbContext dbContext) =>
            {
